    ...
    for (i = 0; i < max_iteration; i++)
        {
            ...
            {
                next_generation[j]->evaluate(next_generation[j],target);
            }
            ...
            // 10% of previous generation best and 90% of next_generation best
            for (j = population_size * 0.3 ; j< population_size ; j++){
